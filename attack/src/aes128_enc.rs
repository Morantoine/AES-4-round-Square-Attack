...
const RC : [u8; 10] = [0x01, 0x02, 0x04, 0x08,
...
fn next_aes128_round_key(prev_key : &[u8],
    next_key : &mut[u8], round : usize) {
 ...
 * @nrounds <= 10
 */
pub fn aes128_enc(block : &mut[u8; AES_BLOCK_SIZE], key : [u8; AES_128_KEY_SIZE], nrounds : usize, lastfull : bool)
{
